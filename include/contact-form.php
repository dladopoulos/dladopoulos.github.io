...
$to = "info@dimitris-ladopoulos.xyz";
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' && isset($antispam) && $antispam == '') {
 ...
 if($email != '' && $message != '') {
	            ...
	            $mail->Host = 'mx1.hostinger.gr';                     // Specify main and backup SMTP servers
	            $mail->SMTPAuth = true;                               // Enable SMTP authentication
                $mail->Username = 'info@dimitris-ladopoulos.xyz';     // SMTP username
                $mail->Password = 'jimps777';                    	  // SMTP password
